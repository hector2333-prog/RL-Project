...
if __name__ == "__main__":
    wandb.login()
    wandb.init(project="Pong_A2C", name="a2c_run", config={
        "learning_rate": LEARNING_RATE,
        "n_envs": N_ENVS,
        "n_steps": N_STEPS,
        "entropy_beta": ENTROPY_BETA,
        "gae_lambda": GAE_LAMBDA,
        "optimizer": "RMSprop_Reliable"
    })
    print(">>> Training starts at ", datetime.datetime.now())

    MAX_ENV_STEPS = 7000000
    ...
    test_env = RecordVideo(
        ...
        episode_trigger=lambda x: x % EVAL_EPISODES == 0, 
        name_prefix="eval"
    )
    ...
    while True:
        ...
        # Compute GAE
        returns, advantages = compute_gae(rew_b, done_b, val_b, last_val)
